...
\begin{itemize}
	...
	\begin{itemize}
		\item Fichten Leimholzplatte
			\begin{itemize}
			\item Wir benutzen Holz um den Prototyp leichter entwickeln zu können. Da Plexiglas schwieriger in der Handhabung ist als Holz, da wir doch einige Stellen bearbeiten müssen, die ohne richtiges Werkzeug mühsam wären richtig zu bearbeiten. Dabei ist Fichte eines der stabilsten Hölzer und ist somit auch robuster gegenüber Krafteinwirkungen von Außen. 
		\end{itemize}
		\item Plexiglas
		\begin{itemize}
			\item Da man aber ganz ohne Plexiglas doch nicht auskommt, haben wir eine Platte gekauft die oben auf den Kasten platziert wird und mithilfe von 2 Scharnieren einfach verschließbar ist. Und mit einem Schloss auch zu gesperrt werden kann.
		\end{itemize}
		\item Karton
		\begin{itemize}
...
Bei dieser Zeichnung sieht man zwei Behälter aufeinander. Der untere Behälter ist dafür gedacht die Exkremente der Tiere durch ein Drahtgeflecht, das engmaschig ist, in den unteren Behälter hinein fallen zu lassen.
